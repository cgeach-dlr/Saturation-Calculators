...
lamb0 =  393.477 * 10**-9 #m, in vacuum
nu0 = c_light / lamb0
A_i = 1.47e8 #Hz
tau_R = 1 / A_i * 1e9 #ns
...
nu_42 = 426.1 * 10**6 #Hz - relative frequency shift 
nu_44 = 850.1 * 10**6 #Hz - relative frequency shift 
nu_46 = 1299.1 * 10**6 #Hz - relative frequency shift
