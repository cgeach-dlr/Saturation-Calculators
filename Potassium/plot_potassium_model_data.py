...
Data_K_int_spectrum = np.loadtxt(Data_K_int_spectrum_fname,
                                 delimiter=',').T
Data_K_eff_spectrum = np.loadtxt(Data_K_eff_spectrum_fname,
                                 delimiter=',').T

lambda_shifts = Data_K_int_spectrum[0]
lines = Data_K_int_spectrum[1:,:]
combined_spectrum = Data_K_eff_spectrum[1]
doppler_spectrum = Data_K_eff_spectrum[2]
...
ax[0].plot(lambda_shifts, lines[0], linestyle='-',
              label=r'$^{39}\alpha^1_1$', color=colors[0])
ax[0].plot(lambda_shifts, lines[1], linestyle='-',
              label=r'$^{39}\alpha^2_1$', color=colors[1])
ax[0].plot(lambda_shifts, lines[2], linestyle='-',
              label=r'$^{39}\alpha^1_2$', color=colors[2])
ax[0].plot(lambda_shifts, lines[3], linestyle='-',
              label=r'$^{39}\alpha^2_2$', color=colors[3])
ax[0].plot(lambda_shifts, lines[4], linestyle='--',
              label=r'$^{41}\alpha^1_1$', color=colors[0])
ax[0].plot(lambda_shifts, lines[5], linestyle='--',
              label=r'$^{41}\alpha^2_1$', color=colors[1])
ax[0].plot(lambda_shifts, lines[6], linestyle='--',
              label=r'$^{41}\alpha^1_2$', color=colors[2])
ax[0].plot(lambda_shifts, lines[7], linestyle='--',
              label=r'$^{41}\alpha^2_2$', color=colors[3])
ax[1].plot(lambda_shifts, combined_spectrum,
           label='Homogeneous broadening')
ax[1].plot(lambda_shifts, doppler_spectrum, 'k--',
...
ax[0].plot(lambda_Ls, sats_gauss_nuL)
ax[0].plot(lambda_Ls, sats_lorentz_nuL)
ax[0].plot(lambda_Ls, sats_Megie_nuL)
