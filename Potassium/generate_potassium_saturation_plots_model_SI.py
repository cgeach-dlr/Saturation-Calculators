...
for i in range(len(nu_Ls)):
    ...
    sats_gauss_nuL[i] = k_lib.get_saturation_beam_uncorrected(nu_L, Delta_nu_L,
                                         ...
                                         nt, delta_t, delta_r, Temp_K, 'gauss',
                                         ratio_beam=True)
    sats_lorentz_nuL[i] = k_lib.get_saturation_beam_uncorrected(nu_L,
                                         Delta_nu_L, N_L, z, T_atm, alpha_L,
...
for i in range(len(Es)):
    ...
    sats_gauss_E[i] = k_lib.get_saturation_beam_uncorrected(0, Delta_nu_L, N_L,
                                         ...
                                         delta_t, delta_r, Temp_K, 'gauss',
                                         ratio_beam=True)
    sats_lorentz_E[i] = k_lib.get_saturation_beam_uncorrected(0, Delta_nu_L,
                                         N_L, z, T_atm, alpha_L, alpha_T, t_L,
...
for i in range(len(Es)):
    ...
    N_L = k_lib.N_L_from_pulse_energy(Es[i])
    Res_gauss_200 = k_lib.get_wind_and_temp_errors_uncorrected(200, nu_Ls_errs,
                              Delta_nu_L, N_L, z, T_atm, alpha_L, alpha_T, t_L,
                              nt, delta_t, delta_r, 'gauss', False)
    Res_lorentz_200 = k_lib.get_wind_and_temp_errors_uncorrected(200,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L,
                              alpha_T, t_L, nt, delta_t, delta_r, 'lorentzian',
                              False)
    Res_gauss_150 = k_lib.get_wind_and_temp_errors_uncorrected(150, nu_Ls_errs,
                              Delta_nu_L, N_L, z, T_atm, alpha_L, alpha_T, t_L,
                              nt, delta_t, delta_r, 'gauss', False)
    Res_lorentz_150 = k_lib.get_wind_and_temp_errors_uncorrected(150,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L,
                              alpha_T, t_L, nt, delta_t, delta_r, 'lorentzian',
                              False)
    
    Res_gauss_200_noise = k_lib.get_wind_and_temp_errors_uncorrected(200,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L, 
                              alpha_T, t_L, nt, delta_t, delta_r, 'gauss', True)
    Res_lorentz_200_noise = k_lib.get_wind_and_temp_errors_uncorrected(200,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L,
                              alpha_T, t_L, nt, delta_t, delta_r, 'lorentzian',
                              True)
    Res_gauss_150_noise = k_lib.get_wind_and_temp_errors_uncorrected(150,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L, 
                              alpha_T, t_L, nt, delta_t, delta_r, 'gauss', True)
    Res_lorentz_150_noise = k_lib.get_wind_and_temp_errors_uncorrected(150,
                              nu_Ls_errs, Delta_nu_L, N_L, z, T_atm, alpha_L,
                              alpha_T, t_L, nt, delta_t, delta_r, 'lorentzian',
                              True)
